...
<head>
    ...
    <title>Créer un Utilisateur - Mon Espace QCM</title>
        ...
        <main class="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-border p-8">
                ...
                <div class="mb-8 text-center">
                    ...
                    <p class="mt-2 text-text-muted">Ajoutez un enseignant ou un étudiant au système</p>
                </div>
                ...
                {{-- Formulaire --}}
                <form id="create-form" action="{{ route('users.store') }}" method="POST" class="space-y-6">
                    @csrf
